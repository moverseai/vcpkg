# set(VCPKG_CXX_FLAGS "/arch:SSE2 -DEIGEN_DONT_ALIGN_STATICALLY=1 -DEIGEN_MAX_ALIGN_BYTES=32 ${VCPKG_CXX_FLAGS}") # TODO: /arch: flag requires compiler check. needs to be MSVC
# set(VCPKG_C_FLAGS "/arch:SSE2 -DEIGEN_DONT_ALIGN_STATICALLY -DEIGEN_MAX_ALIGN_BYTES=32 ${VCPKG_C_FLAGS}")

set(VCPKG_CXX_FLAGS "/arch:SSE2 -DEIGEN_MAX_ALIGN_BYTES=32 ${VCPKG_CXX_FLAGS}") # TODO: /arch: flag requires compiler check. needs to be MSVC
set(VCPKG_C_FLAGS "/arch:SSE2 -DEIGEN_MAX_ALIGN_BYTES=32 ${VCPKG_C_FLAGS}")

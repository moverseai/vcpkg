# set(VCPKG_CXX_FLAGS "/arch:AVX2 -DEIGEN_DONT_ALIGN_STATICALLY=1 -DEIGEN_MAX_ALIGN_BYTES=32 ${VCPKG_CXX_FLAGS}") # TODO: /arch: flag requires compiler check. needs to be MSVC
# set(VCPKG_C_FLAGS "/arch:AVX2 -DEIGEN_DONT_ALIGN_STATICALLY -DEIGEN_MAX_ALIGN_BYTES=32 ${VCPKG_C_FLAGS}")

set(VCPKG_CXX_FLAGS "/arch:AVX2 -DEIGEN_MAX_ALIGN_BYTES=32 ${VCPKG_CXX_FLAGS}") # TODO: /arch: flag requires compiler check. needs to be MSVC
set(VCPKG_C_FLAGS "/arch:AVX2 -DEIGEN_MAX_ALIGN_BYTES=32 ${VCPKG_C_FLAGS}")
...
file(READ "${CURRENT_PACKAGES_DIR}/include/g2o/config.h" _contents)
...
file(WRITE "${CURRENT_PACKAGES_DIR}/include/g2o/config.h" "${_contents}")
